      ...
      >
        ...
        <div className="approach h-[65vh] flex gap-3 px-14 pt-4 w-full pb-8">
          ...
          >
            ...
            <a href="https://drive.google.com/file/d/1854NWg9uAUr_brKJlDDBvfFvRsKn71U7/view?usp=sharing" target="_blank" className=" flex gap-8 items-center justify-between uppercase bg-gray-900 text-white text-base py-5 px-6 rounded-full">
              Read More
