    ...
    >
      <div className="w-1/2 h-[60vh] bg-[#163e45] relative rounded-lg overflow-hidde flex items-center justify-center">
        ...
        <div className="absolute bottom-0 left-0 px-8 py-8">
          <h1 className="px-3 py-1 uppercase border border-[#dbc49f] text-[#dbc49f] rounded-full text-sm tracking-widest font-NeueMontreal">
            Dv64bit
          </h1>
        </div>
      </div>
      <div className="w-1/2  h-[60vh] flex gap-3">
        <div className="w-1/2 h-full bg-[#FBF6EE] relative rounded-lg overflow-hidde flex items-center justify-center">
          ...
          />
          <div className="absolute bottom-0 left-0 px-8 py-8">
            <h1 className="px-3 py-1 uppercase border border-[#001317] text-[#001317] rounded-full text-sm tracking-widest font-NeueMontreal">
              Studentflow
            </h1>
          </div>
        </div>
        <div className="w-1/2 h-full bg-[#F3EDC8] relative rounded-lg overflow-hidde flex items-center justify-center">
          ...
          />
          <div className="absolute bottom-0 left-0 px-8 py-8">
            <h1 className="px-3 py-1 uppercase border border-[#461309] text-[#461309] rounded-full text-sm tracking-widest font-NeueMontreal">
              yana
            </h1>
          </div>
        </div>
